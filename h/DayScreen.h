/*****************************************************************************
* 
* This header file declares the DayScreen class.
*
*****************************************************************************/
/*****************************************************************************
...
class DayScreen : public Screen
{
    private:
        string curr_day;
        DayTasks day_tasks;
        DayTasks all_tasks; /* day tasks + recurrent tasks */
        int sel_row;   
    public:
        DayScreen(Date& date, int& sel_task);
        void display(int& first_task, int& sel_task);
        int interact(Date& date, int& first_task, int& sel_task, int& clr_scr);
	int matchRecurrentTask(RecurrentTask recurrentTask);
	void generateAllTasks(void);
};
